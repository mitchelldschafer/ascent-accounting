...
export default function Hero() {
  ...
  return (
    <section ref={container} className="relative w-full h-[100dvh] bg-obsidian flex flex-col justify-end pb-24 md:pb-32 px-6 md:px-12 lg:px-24 overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-10 w-full max-w-4xl pt-24 text-slateWhite">
        <h1 className="flex flex-col gap-2">
          <span className="hero-anim font-heading font-bold text-lg md:text-xl lg:text-2xl text-slateWhite/70 tracking-tight">
        ...
        <div className="hero-anim mt-10 md:mt-14 flex flex-col sm:flex-row items-baseline sm:items-center gap-6">
          <Link to="/contact" className="relative group overflow-hidden bg-amber text-obsidian px-8 py-4 rounded-full font-ui text-base font-semibold hover:scale-[1.02] transition-transform duration-300 ease-[cubic-bezier(0.25,0.46,0.45,0.94)]">
          ...
          <div className="font-mono text-[10px] sm:text-xs text-slateWhite/50 flex flex-wrap items-center gap-3 uppercase tracking-wider">
            <span>Est. 2012</span>
            <span className="w-1 h-1 rounded-full bg-slateWhite/30"></span>
